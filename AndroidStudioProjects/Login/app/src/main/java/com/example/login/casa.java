...
public class casa extends AppCompatActivity {
    Button btAssolan,btVeja,btToalha,btPano;
    Button btTotal,btCalcular,btChamarCarrinho;
    EditText edtTotal,edtQuantidade,tvescondido,edtAssolan;
    String Total,TotalDefinitivo;
    public String quantidade_final;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btAssolan = (Button) findViewById(R.id.btAssolan);
        btPano = (Button) findViewById(R.id.btPano);
        btToalha = (Button) findViewById(R.id.btToalha);
        btVeja = (Button) findViewById(R.id.btVeja);
        edtAssolan = (EditText) findViewById(R.id.edtAssolan);
        ...
        btChamarCarrinho = (Button) findViewById(R.id.btchamarCarrinho);
        ...
        btAssolan.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                double assolan = 5;
                Double E = assolan;
        ...
        /*btPano.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                double toalha = 2.0;
                Double tt = toalha;
